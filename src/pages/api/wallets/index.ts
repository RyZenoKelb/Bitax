...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  // Rediriger vers la fonction appropriée en fonction de la méthode HTTP
  switch (req.method) {
    case 'GET':
      return handleGetWallets(req, res, session.user.id);
    case 'POST':
...
// Fonction pour récupérer tous les wallets d'un utilisateur
async function handleGetWallets(req: NextApiRequest, res: NextApiResponse, userId: string) {
  try {
...
// Fonction pour ajouter un wallet
...
// Fonction pour mettre à jour un wallet
