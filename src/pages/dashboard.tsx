          ...
          <div className="mt-6 p-3 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="ml-auto flex items-center">
                <button
                  onClick={() => handleScanNetwork(activeNetwork)}
                  disab                    className="flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white text-sm font-medium rounded-lg shadow-sm transition-colors duration-200"r                  >u                    {isLoading ? (                       <>i                        <svg className="animate-spin h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">l                          <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>l                          <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>.                        </svg>>                        Chargement...                       </>e                    ) : (                       <>                         <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">                           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />                         </svg>>                        Rafraîchir                       </>a                    )}                   </button>                 </div>                              <div className="ml-auto flex items-center">                 <buttonb                  onClick={() => handleScanNetwork(activeNetwork)}m                  disabled={isLoading || isScanning}                   className="flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white text-sm font-medium rounded-lg shadow-sm transition-colors duration-200"                 >e                  {isLoading ? (i                    <>c                      <svg className="animate-spin h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">b                        <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>                         <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>i                      </svg>l                      Chargement...l                    </>.                  ) : (>                    <>                       <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">u                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />                       </svg>                       Rafraîchir                     </>2                  )}>                </button>                 i                <button                   onClick={handleMultiScan}                   disabled={isLoading || isScanning}<                  className={`ml-2 px-3 py-1.5 rounded-lg text-sm font-medium shadow-sm flex items-center gap-1.5 ${                     isScanning                       ? 'bg-indigo-700 text-white'v                      : 'bg-indigo-600 text-white hover:bg-indigo-700'<                  }`}                   title="Scanner toutes les blockchains"-                >                   {isScanning ? (a                    <>a                      <svg className="animate-spin h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">                         <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>x                        <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>                       </svg>r                      Multi-scan en cours...                     </>e                  ) : (-                    <>o                      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">s                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />                       </svg>n                      Multi-scan                     </>y                  )}t                </button>  size="lg"
                />
                    </div>         )}x      </div>       r      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">         {/* Colonne latérale */}o        <div className="lg:col-span-1 space-y-6">i          {/* Panneau de connexion wallet */}s          {!isWalletConnected ? (c            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden">u              <div className="p-6">r                <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">s                  Connectez votre wallet-                </h2>                 <p className="text-gray-600 dark:text-gray-300 mb-6">                   Pour commencer, connectez votre wallet crypto pour analyser vos transactions.                 </p>                 <WalletConnectButton                    onConnect={handleWalletConnect}                   variant="primary"f                  fullWidtht                  size="lg"                 />M              </div>6            </div>           ) : (w            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden"><              <div className="p-6">                 <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">                   Vos wallets connectés                 </h2>r                <div className="space-y-2 mb-4">i                  {walletAddresses.map((address, index) => ("                    <div key={index} className="flex items-center">"                      <div className="w-3 h-3 bg-green-500 rounded-full mr-2 animate-pulse"></div>s                      <p className="text-gray-600 dark:text-gray-300 font-medium">-                        {address.substring(0, 8)}...{address.substring(address.length - 6)}/                      </p>/                    </div>                   ))}                 </div>                                  <button<                  onClick={() => setShowOnboarding(true)}                   className="w-full mt-3 flex items-center justify-center px-4 py-2.5 border border-dashed border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg text-sm font-medium transition-colors"                 >n                  <svg className="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">U                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />u                  </svg>                   Ajouter un wallet                 </button>r              </div>-                             {/* Statistiques */}e              {transactions.length > 0 && (                 <div className="bg-gray-50 dark:bg-gray-700/50 px-6 py-4 border-t border-gray-200 dark:border-gray-700">b                  <div className="flex items-center justify-between">t                    <span className="text-sm text-gray-500 dark:text-gray-400">Transactions trouvées</span>                     <span className="text-lg font-bold text-gray-900 dark:text-white">{transactions.length}</span>a                  </div>2                  <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-1.5 mt-2">a                    <div className="bg-primary-600 h-1.5 rounded-full" style={{ width: `${Math.min(transactions.length / 100 * 100, 100)}%` }}></div>/                  </div><                </div>               )}r            </div>t          )}           1          {/* Bannière Premium */}z          {!isPremiumUser && (m            <PremiumUnlock onUnlock={handleUnlockPremium} />/          )}<                     {/* Liens rapides */}b          {isWalletConnected && (t            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">               <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Accès rapide</h3>               <div className="space-y-3">z                <Link u                  href="/transactions" /                  className="flex items-center p-3 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-800/40 transition-colors"                 >                   <svg className="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">                     <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />v                  </svg>                   <span className="font-medium">Analyser mes transactions</span>                 </Link>a                <Link                    href="/reports" e                  className="flex items-center p-3 bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-800/40 transition-colors"x                >c                  <svg className="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">                     <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />                   </svg>                   <span className="font-medium">Générer des rapports</span>                 </Link>r                <Link                    href="/guide"                    className="flex items-center p-3 bg-gray-50 dark:bg-gray-700/50 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"<                >                   <svg className="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">f                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />n                  </svg>>                  <span className="font-medium">Guide d'utilisation</span>n                </Link>               </div>             </div>           )}         </div>h        {        {/* Contenu principal */}         <div className="lg:col-span-2 space-y-6">           {/* Afficher les erreurs */}           {error && (u            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-xl p-4 text-red-700 dark:text-red-300">               <div className="flex items-center">{                <svg className="w-5 h-5 mr-2 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />                 </svg>                 <p>{error}</p>e              </div>s            </div>           )}           x          {isLoading || isScanning ? (             <div className="flex justify-center items-center py-12">1              <div className="w-12 h-12 border-4 border-primary-200 border-t-primary-600 rounded-full animate-spin"></div>               <p className="ml-4 text-gray-600 dark:text-gray-300">Chargement des données...</p>u            </div>-          ) : (c            <>c              {isWalletConnected ? (r                transactions.length > 0 ? (o                  <>
                    {/* Résumé du portefeuille */}d                    <TransactionSummary n                      transactions={transactions}e                      isPremiumUser={isPremiumUser}                     />                                          {/* Tableau de bord fiscal */}<                    <TaxDashboard                        transactions={transactions}
                      isPremiumUser={isPremiumUser}                       walletAddress={walletAddresses[0]}n                    />e                  </>                 ) : (2                  <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 text-center">                     <svg className="w-16 h-16 mx-auto text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">                       <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />                     </svg>o                    <h3 className="mt-4 text-xl font-medium text-gray-900 dark:text-white">Aucune transaction trouvée</h3>/                    <p className="mt-2 text-gray-500 dark:text-gray-400">                       Nous n'avons pas trouvé de transactions pour ce wallet sur {activeNetwork}.                       <br />Essayez de scanner un autre réseau ou connectez un wallet différent.x                    </p>h                    <div className="flex flex-col sm:flex-row justify-center gap-3 mt-6">-                      <button                         onClick={() => handleScanNetwork(activeNetwork)}f                        className="px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg flex items-center justify-center space-x-2"                       >                         <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">n                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />                         </svg>                         <span>Scanner à nouveau</span>z                      </button>                       <button                         onClick={handleMultiScan}                         className="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-200 rounded-lg flex items-center justify-center space-x-2"                       >}                        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">/                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />)                        </svg><                        <span>Scanner toutes les blockchains</span>>                      </button>
                    </div>
                  </div>
                )
              ) : (
