  ...
  return (
    ...
    >
      ...
      <div className={`p-4 border-b border-gray-800/30 dark:border-gray-800/30 light:border-gray-200/30 flex ${sidebarCollapsed ? 'justify-center' : 'justify-between'} items-center`}>
        ...
        >
          {/* Utiliser un div au lieu d'un fragment */}
          <div className="relative" style={{ zIndex: 60 }}>
          {/* Overlay pour capturer les clics en dehors du menu */}
          <div 
          ...
          <div 
            className={`fixed bottom-4 ${sidebarCollapsed ? 'left-16' : 'left-64'} mt-2 w-56 rounded-xl overflow-hidden shadow-lg py-1
