...
// Logo SVG with futuristic style
  ...
  return (
    <div className="flex items-center">
      <div className="flex flex-col">
        <span className="text-2xl font-extrabold font-display bg-clip-text text-transparent bg-gradient-to-r from-primary-500 via-secondary-500 to-primary-400 tracking-tight"></span>
          BITAX
        </span>
...
export default function App({ Component, pageProps }: AppProps) {
  ...
  useEffect(() => {
    ...
    // Delay to prevent flash during load
    setTimeout(() => {
      setIsLoaded(true);
    }, 100);
  }, []);
  ...
  // Open sidebar by default on desktop for dashboard pages
  useEffect(() => {
  ...
  return (
    <AuthProvider>
      <Head>
        ...
        <meta
          name="description"
          content="Bitax - Révolutionnez votre fiscalité crypto avec notre plateforme IA de pointe. Analyses en temps réel, rapports automatisés."
        />
        ...
        <meta
          name="twitter:title"
          content="Bitax | Fiscalité crypto redéfinie"
        />
        <meta
          name="twitter:description"
          content="Révolutionnez votre fiscalité crypto avec notre plateforme IA de pointe. Analyses en temps réel, rapports automatisés."
        />
