...
const WalletsPage: NextPage = () => {
  ...
  const [isPremiumUser, setIsPremiumUser] = useState<boolean>(
    typeof window !== 'undefined' ? localStorage.getItem('bitax-premium') === 'true' : false
  );

  useEffect(() => {
    // Charger les wallets depuis le localStorage au démarrage
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            {activeWalletId && wallets.length > 0 ? (
              <>
