      ...
      <header className="sticky top-0 z-50 backdrop-blur-xl bg-gray-900/80 border-b border-gray-800/50 py-4 px-6">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-1">
            ...
            <Link href="/tarifs" className="nav-link-dashboard px-3 py-2 rounded-lg text-white hover:bg-gray-800/70 transition-colors">
              <div className="flex items-center">
                <svg className="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <footer className="py-6 backdrop-blur-xl bg-gray-900/80 border-t border-gray-800/50">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="mt-2 space-x-4">
            ...
            <Link href="/tarifs" className="text-gray-400 hover:text-white transition-colors text-sm">Tarifs</Link>
