...
export default function Home() {
  // Référence pour le canvas d'animation de particules
  const canvasRef = useRef(null);
  
  // Effet pour initialiser l'animation des particules
  useEffect(() => {
    ...
    const colors = ['#4f46e5', '#7e3af2', '#2563eb', '#8b5cf6', '#3b82f6'];
    ...
    function animate() {
      ...
      // Dessiner des connexions entre les particules proches
